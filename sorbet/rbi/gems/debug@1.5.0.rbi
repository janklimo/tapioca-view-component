...
class DEBUGGER__::SourceRepository::SrcInfo < ::Struct
  ...
  #
  # @return [Object] the current value of colored
  def colored; end

  # Sets the attribute colored
  #
  # @param value [Object] the value to set the attribute colored to.
  # @return [Object] the newly set value
  def colored=(_); end
  ...
  #
  # @param value [Object] the value to set the attribute src to.
  # @return [Object] the newly set value
  def src=(_); end
